...
namespace Rider.Route.Tests
{
	...
	public class RouteModuleTests
	{
		...
		public void OnInitializedTest()
		{
			...
			manager.Verify(m => m.RegisterViewWithRegion(Regions.ToolBar, typeof(Views.ToolBar)));
		...
		public void RegisterTypesTest()
		{
			...
			registry.Verify(r => r.Register(typeof(object), typeof(Views.ToolBar), Constants.Views.RouteToolBar));
